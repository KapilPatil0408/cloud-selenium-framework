...
public abstract class BrowserUtility {
	...
	//	WebElement element = driver.get().findElement(textBoxlocator);
		...
		logger.info("Found element now clearing text box");
		element.clear();
	}
	...
	//	WebElement element = driver.get().findElement(locator);
		WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(locator));
		logger.info("Found element now entering special key " + keyToEnter);
	...
	public String getVisibleText(WebElement element) {
		logger.info("Returning text of element" + element.getText());
		return element.getText();
	}
	...
	public List<String> getAllVisibleText(By locator) {
		...
		logger.info("Found element now returning printing list of element");
	...
	public List<WebElement> getAllElements(By locator) {
		logger.info("Finding element with locator " + locator);
		List<WebElement> elementList = driver.get().findElements(locator);
		logger.info("Found element now returning list of elements");
