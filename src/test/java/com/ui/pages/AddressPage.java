...
public class AddressPage extends BrowserUtility {
	...
	public String saveAddress(AddressPOJO addressPOJO) {
		...
		enterText(ADDRESS1_TEXTBOX_LOCATOR, addressPOJO.getAddresLine1());
		enterText(ADDRESS2_TEXTBOX_LOCATOR, addressPOJO.getAddresLine2());
		enterText(CITY_TEXTBOX_LOCATOR, addressPOJO.getCity());
		enterText(POST_CODE_TEXTBOX_LOCATOR, addressPOJO.getPostCode());
		enterText(HOME_PHONE_CODE_TEXTBOX_LOCATOR, addressPOJO.getHomePhoneNumber());
		...
		enterText(ADDRESS_ALIAS_TEXTBOX_LOCATOR, addressPOJO.getAddresAlias());
